...
export class Autocomplete extends Component {
  ...
  onBlur = (e) => this.setState({ ...this.state, showOptions: false });
  ...
  success = async (position) => {
    ...
    localStorage.setItem("geoLocation", this.state.userInput);
  ...
  componentDidMount() {
    ...
    if (!window.localStorage.getItem("geoLocation")) this.gpsLocHandler();
  }
